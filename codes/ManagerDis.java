...
public class ManagerDis extends JFrame implements ActionListener{
    JButton b1,b2;
    JFrame f;
    JTable t1;
    ...
    ManagerDis(){
       ...
       JFrame frame = new JFrame();
        ...
        t1 = new JTable(d);
        String  header[] = {"ID","First Name","Last Name","Age","Gender","Department","Salary","Phone","Aadhar","Email"};
        ...
        t1.getColumnModel().getColumn(9).setPreferredWidth(200);
       ...
       /* b2 = new JButton("Back");
        ...
        frame.setTitle("Manager Details");
